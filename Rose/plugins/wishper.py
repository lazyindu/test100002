...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@MissLazyRose_bot [@username] text`")
        description = "Usage: @MissLazyRose_bot [@username] text"
        button = InlineKeyboardButton(
            "More-Help",
            url="https://t.me/MissLazyRose_bot?start=learn"
        )
...
@MissLazyRose_bot your whisper @username
...
example:- 
@MissLazyRose_bot hello this is a test @LazyDeveloperr
