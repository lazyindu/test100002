...
my news channel @TheMissLazyRose_bot.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/MissLazyRose_bot?start=help"),
            ]))
        ...
        if member.id == 5965340120:#for @LazyDeveloperr 
            return await app.send_message(
                message.chat.id,
